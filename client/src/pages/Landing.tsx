          ...
          <section className="relative py-24 px-6 overflow-hidden">
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 font-sans leading-relaxed">
                Structured practice drills, style rules, and step-by-step
                lessons to take you from scratcher to artist.
              </p>

              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Button
                  size="lg"
                  className="h-14 px-8 text-lg font-bold bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/20 transition-all hover:scale-105"
            ...
            <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-12">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Don&apos;t just copy. Understand the rules, history, and
                  definitions of American Traditional, Neo-Trad, and more.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Build muscle memory with specific, timed exercises designed to
                  improve line confidence and shading.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Keep a digital portfolio of your practice sheets. Watch your
                  lines get cleaner over time.
                </p>
              </div>
            </div>
          </section>
